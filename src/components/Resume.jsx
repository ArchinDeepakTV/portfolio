      ...
      >
        ...
        <ul className="mt-3 mr-3">
          ...
          <li className="ml-4">
            ...
            <p className="ml-4">
              Worked on a machine learning model to analyze and plot the demand
              of different medications throughout the year.
            </p>
          </li>
          <li className="ml-4">
            <b>HLL Lifecare Ltd.:</b> Sept, 2023 -
            <p className="ml-4">
              Worked on managing an in-house built project which was being done
              for a Department of Government of India. Worked on managing the IT
              systems of multiple centres.
            </p>
          </li>
        </ul>
        <br />
      ...
      >
        <ul className="mt-3">
          ...
          <li className="ml-4">
            ...
            <p className="ml-4">
              A website acting as a book database which contains the basic info
              about the book. And, users can leave a comment about the book they
              have already read. Still under works with a collaborator.
            </p>
          </li>
          <br />
          <li className="ml-4">
            ...
            <p className="ml-4">
              A virtual assistant like Google Assistant works on Laptops. Can be
              modified to work on any operating System. Accepts voice-based
